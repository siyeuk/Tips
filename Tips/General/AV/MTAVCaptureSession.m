...
@interface MTAVCaptureSession ()<AVCapturePhotoCaptureDelegate, AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureAudioDataOutputSampleBufferDelegate>
...
@implementation MTAVCaptureSession

+ (instancetype)sharedAVCaptureSession{
    static MTAVCaptureSession *avCaptureSession = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        avCaptureSession = [[MTAVCaptureSession alloc] init];
    });
