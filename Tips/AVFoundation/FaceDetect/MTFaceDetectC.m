...
//输出元数据流，可以捕获输出二维码、条形码、人脸/猫/狗数据等
...
//捕捉到数据
/*
 AVMetadataObjectTypeAztecCode                  Aztec Code 条形码
 AVMetadataObjectTypeFace                       面部特征
 AVMetadataObjectTypeQRCode                     二维码
 AVMetadataObjectTypeUPCECode                   UPC-E 商品条形码
 AVMetadataObjectTypePDF417Code                 PDF417二维条码
 AVMetadataObjectTypeITF14Code                  外箱条码ITF-14
 AVMetadataObjectTypeInterleaved2of5Code        交叉二五条码
 AVMetadataObjectTypeEAN8Code                   EAN-8条码
 AVMetadataObjectTypeEAN13Code                  EAN-13（包括UPC-A）条码
 AVMetadataObjectTypeDataMatrixCode             二维条码
 */
