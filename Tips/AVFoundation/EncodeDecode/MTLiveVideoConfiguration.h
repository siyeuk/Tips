...
typedef NS_ENUM (NSUInteger, MTLiveVideoSessionPreset){
    /// 低分辨率
    MTCaptureSessionPreset360x640 = 0,
    /// 中分辨率
    MTCaptureSessionPreset540x960 = 1,
    /// 高分辨率
    MTCaptureSessionPreset720x1280 = 2
};

/// 视频质量
typedef NS_ENUM (NSUInteger, MTLiveVideoQuality){
    /// 分辨率： 360 *640 帧数：15 码率：500Kps
    MTLiveVideoQuality_Low1 = 0,
    /// 分辨率： 360 *640 帧数：24 码率：800Kps
    MTLiveVideoQuality_Low2 = 1,
    /// 分辨率： 360 *640 帧数：30 码率：800Kps
    MTLiveVideoQuality_Low3 = 2,
    /// 分辨率： 540 *960 帧数：15 码率：800Kps
    MTLiveVideoQuality_Medium1 = 3,
    /// 分辨率： 540 *960 帧数：24 码率：800Kps
    MTLiveVideoQuality_Medium2 = 4,
    /// 分辨率： 540 *960 帧数：30 码率：800Kps
    MTLiveVideoQuality_Medium3 = 5,
    /// 分辨率： 720 *1280 帧数：15 码率：1000Kps
    MTLiveVideoQuality_High1 = 6,
    /// 分辨率： 720 *1280 帧数：24 码率：1200Kps
    MTLiveVideoQuality_High2 = 7,
    /// 分辨率： 720 *1280 帧数：30 码率：1200Kps
    MTLiveVideoQuality_High3 = 8,
    /// 默认配置
    MTLiveVideoQuality_Default = MTLiveVideoQuality_Low2
};

@interface MTLiveVideoConfiguration : NSObject
...
///< 分辨率
@property (nonatomic, assign) MTLiveVideoSessionPreset sessionPreset;
