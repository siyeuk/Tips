...
-(void)setUpTexture {
    ...
    NSString *filePath = [[NSBundle bundleWithPath:myBundlePath] pathForResource:@"素材1" ofType:@"png" inDirectory:@"Images"];
